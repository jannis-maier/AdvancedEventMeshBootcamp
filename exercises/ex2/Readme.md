...
3. Fill in following **Name:** User**XXX** where <b>XXX</b> is your user number and a short <b>description</b> eg. "Integration Package for event mediation from User 000". Then click <b>Save</b>.
  <br>![](./images/ex2-3.png)
